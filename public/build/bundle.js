...
var app = (function () {
    ...
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(30:2) <Button buttonUrl=\\\"/auth\\\">",
    		ctx
    	});
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 14, 2, 350);
    			add_location(small, file$3, 21, 2, 508);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*helperText*/ 16) set_data_dev(t1, /*helperText*/ ctx[4]);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			small = element("small");
    			t4 = text(/*helperText*/ ctx[4]);
    			attr_dev(label_1, "for", "input");
    			attr_dev(label_1, "class", "mb-2 font-body text-gray text-lg");
    			add_location(label_1, file$3, 9, 1, 158);
    			attr_dev(i, "class", i_class_value = `fas fa-${/*icon*/ ctx[1]} absolute mt-3 md:mt-3 ml-3 text-gray`);
    			add_location(i, file$3, 11, 2, 263);
    			attr_dev(span, "class", "md:text-lg");
    			add_location(span, file$3, 10, 1, 235);
    			attr_dev(small, "class", "text-2xs ml-auto");
    			add_location(small, file$3, 23, 1, 546);
    			add_location(main, file$3, 8, 0, 150);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (default_slot) {
    				...
    				if (default_slot_or_fallback && default_slot_or_fallback.p && dirty & /*helperText, placeholder, value*/ 21) {
    					default_slot_or_fallback.p(ctx, dirty);
    				}
    			}

    			if (!current || dirty & /*helperText*/ 16) set_data_dev(t4, /*helperText*/ ctx[4]);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["icon", "value", "placeholder", "label", "helperText"];
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 6, 1, 84);
    			add_location(main, file$4, 5, 0, 76);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["action", "type"];
    	...
    	$$self.$capture_state = () => ({ action, type });
    	...
    	return [action, type, $$scope, slots];
    }

    class ActionButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { action: 0, type: 1 });
    ...
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(10:0) {#if $authStore.showRecover}",
    		ctx
    	});
    ...
    // (16:2) <Input icon="at" placeholder="email@email.com">
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$5, 16, 3, 571);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(16:2) <Input icon=\\\"at\\\" placeholder=\\\"email@email.com\\\">",
    		ctx
    	});
    ...
    // (26:3) <ActionButton action={() => authStore.toggleItem('showRecover', false)}     >
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(26:3) <ActionButton action={() => authStore.toggleItem('showRecover', false)}     >",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*$authStore*/ ctx[1].showRecover && create_if_block$1(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*$authStore*/ ctx[1].showRecover) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*$authStore*/ 2) {
    						transition_in(if_block, 1);
    					}
    				} else {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	const func = () => authStore.toggleItem("showRecover", false);
    	...
    	return [email, $authStore, input_input_handler, func];
    }
    ...
    /* src/components/auth/RegisterLogin.svelte generated by Svelte v3.32.3 */

    const { console: console_1 } = globals;

    const file$6 = "src/components/auth/RegisterLogin.svelte";
    ...
    function create_else_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t = text("Please fill the information");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    ...
    // (21:2) {#if $authStore.isUser}
    function create_if_block_3(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("Welcome! Please Login to access the app.");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(21:2) {#if $authStore.isUser}",
    		ctx
    	});
    ...
    // (28:2) <Input icon="at" placeholder="email@email.com" label="E-mail">
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "id", "input");
    			attr_dev(input, "placeholder", "email@email.com");
    			attr_dev(input, "class", "block border-gray rounded-md bg-gray-light shadow mb-5 h-10 w-full pl-9");
    			add_location(input, file$6, 28, 3, 860);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(28:2) <Input icon=\\\"at\\\" placeholder=\\\"email@email.com\\\" label=\\\"E-mail\\\">",
    		ctx
    	});
    ...
    // (37:2) <Input icon="lock" label="Password">
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "block border-gray rounded-md bg-gray-light shadow mb-5 h-10 w-full pl-9");
    			add_location(input, file$6, 37, 3, 1099);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(37:2) <Input icon=\\\"lock\\\" label=\\\"Password\\\">",
    		ctx
    	});
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "font-body text-gray mr-auto md:mr-0 text-sm visited:text-gray hover:text-purple-light border-none");
    			add_location(button, file$6, 55, 3, 1643);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "font-body text-gray mr-auto md:mr-0 text-sm visited:text-gray hover:text-purple-light border-none");
    			add_location(button, file$6, 48, 3, 1408);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(48:2) {#if $authStore.isUser}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(65:4) {#if $authStore.isUser}",
    		ctx
    	});
    ...
    // (64:3) <UrlButton buttonUrl="/select-language">
    function create_default_slot$3(ctx) {
    	let if_block_anchor;

    	function select_block_type_2(ctx, dirty) {
    		if (/*$authStore*/ ctx[0].isUser) return create_if_block_1$1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(64:3) <UrlButton buttonUrl=\\\"/select-language\\\">",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$6, 71, 4, 2072);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(71:3) {#if $authStore.isUser}",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	let t5;
    	let current;
    	recoverpassword = new RecoverPassword({ $$inline: true });

    	function select_block_type(ctx, dirty) {
    		if (/*$authStore*/ ctx[0].isUser) return create_if_block_3;
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*$authStore*/ ctx[0].isUser) return create_if_block_2;
    	...
    	let if_block2 = /*$authStore*/ ctx[0].isUser && create_if_block$2(ctx);
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("RegisterLogin", slots, []);
    	let email = "";
    	let password = "";
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<RegisterLogin> was created with unknown prop '${key}'`);
    	});
    	...
    	const click_handler = () => authStore.toggleItem("isUser", false);
    	const click_handler_1 = () => authStore.toggleItem("isUser", true);
    	const click_handler_2 = () => authStore.toggleItem("showRecover", true);
    ...
    class RegisterLogin extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$9(ctx) {
    	let registerlogin;
    	let current;
    	registerlogin = new RegisterLogin({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(registerlogin.$$.fragment);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			mount_component(registerlogin, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(registerlogin.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(registerlogin.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(registerlogin, detaching);
    		}
    	};
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ RegisterLogin });
    	return [];
    }
    ...
    const file$7 = "src/pages/SelectLanguage.svelte";
    ...
    const file$8 = "src/pages/words/Words.svelte";
    ...
    const file$9 = "src/pages/words/SingleWord.svelte";
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$9, 3, 1, 27);
    			add_location(main, file$9, 2, 0, 19);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$a = "src/pages/profile/Profile.svelte";
    ...
    const file$b = "src/pages/profile/EditProfile.svelte";
    ...
    const file$c = "src/components/app-wide/Tobar.svelte";
    ...
    const file$d = "src/components/app-wide/Footer.svelte";
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$d, 6, 21, 169);
    			attr_dev(span0, "class", "px-1");
    			add_location(span0, file$d, 6, 2, 150);
    			...
    			add_location(a0, file$d, 8, 2, 210);
    			attr_dev(p0, "class", "font-body text-gray-light text-2xs md:text-sm");
    			add_location(p0, file$d, 4, 1, 78);
    			attr_dev(i1, "class", "far fa-copyright");
    			add_location(i1, file$d, 18, 3, 469);
    			add_location(span1, file$d, 17, 2, 459);
    ...
    function create_default_slot$4(ctx) {
    	...
    	route0 = new Route({
    			props: { path: "auth", component: Login },
    			$$inline: true
    		});
    	...
    	route2 = new Route({
    			props: { path: "words", component: Words },
    			$$inline: true
    		});

    	route3 = new Route({
    			props: { path: "words/:id", component: SingleWord },
    			$$inline: true
    		});

    	route4 = new Route({
    			props: { path: "profile/:id", component: Profile },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$e, 20, 1, 652);
    		},
    		m: function mount(target, anchor) {
