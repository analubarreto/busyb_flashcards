...
var app = (function () {
    ...
    const file$a = "src/components/app-wide/Tobar.svelte";
    ...
    const file$b = "src/components/app-wide/Footer.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$b, 6, 21, 169);
    			attr_dev(span0, "class", "px-1");
    			add_location(span0, file$b, 6, 2, 150);
    			...
    			add_location(a0, file$b, 8, 2, 210);
    			attr_dev(p0, "class", "font-body text-gray-light text-2xs md:text-sm");
    			add_location(p0, file$b, 4, 1, 78);
    			attr_dev(i1, "class", "far fa-copyright");
    			add_location(i1, file$b, 18, 3, 469);
    			add_location(span1, file$b, 17, 2, 459);
    ...
    function create_default_slot$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$c, 17, 1, 475);
    		},
    		m: function mount(target, anchor) {
