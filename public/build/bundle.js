...
var app = (function () {
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$5, 18, 3, 600);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	let $showRecover;
    	validate_store(showRecover, "showRecover");
    	component_subscribe($$self, showRecover, $$value => $$invalidate(2, $showRecover = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    ...
    // (38:2) <Input icon="at" placeholder="email@email.com" label="E-mail">
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$6, 38, 3, 1006);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(38:2) <Input icon=\\\"at\\\" placeholder=\\\"email@email.com\\\" label=\\\"E-mail\\\">",
    		ctx
    	});
    ...
    // (47:2) <Input icon="lock" label="Password">
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "block border-gray rounded-md bg-gray-light shadow mb-5 h-10 w-full pl-9");
    			add_location(input, file$6, 47, 3, 1245);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(47:2) <Input icon=\\\"lock\\\" label=\\\"Password\\\">",
    		ctx
    	});
    ...
    // (69:3) <UrlButton buttonUrl="/select-language">
    function create_default_slot$3(ctx) {
    	let if_block_anchor;

    	function select_block_type_2(ctx, dirty) {
    		if (/*isUser*/ ctx[2]) return create_if_block_1$1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(69:3) <UrlButton buttonUrl=\\\"/select-language\\\">",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$6, 76, 4, 1953);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*toggleRecover*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_fragment$8(ctx) {
    	...
    	recoverpassword = new RecoverPassword({
    			props: { toggleRecover: /*toggleRecover*/ ctx[3] },
    			$$inline: true
    		});

    	function select_block_type(ctx, dirty) {
    		if (/*isUser*/ ctx[2]) return create_if_block_3;
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*isUser*/ ctx[2]) return create_if_block_2;
    	...
    	let if_block2 = /*isUser*/ ctx[2] && create_if_block$2(ctx);
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*toggleUser*/ ctx[4], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	let $showRecover;
    	validate_store(showRecover, "showRecover");
    	component_subscribe($$self, showRecover, $$value => $$invalidate(7, $showRecover = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	function toggleUser() {
    		return $$invalidate(2, isUser = !isUser);
    	}

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<RegisterLogin> was created with unknown prop '${key}'`);
    	});
